...
(function (a) {
          ...
          if (a.isArray(f)) u(c, f);
            ...
            g &&
              ((q = a("<" + q + ">", {
                ...
                .html(g)
                .appendTo(c)),
              b.oApi._fnBindAction(q, { action: f }, l),
              t++);
          }
        }
      };
  ...
  a(c).on("init.dt", function (b, c) {
    "dt" === b.namespace &&
      ((b = new a.fn.dataTable.Api(c)),
      a.fn.dropdown &&
        a("div.dataTables_length select", b.table().container()).dropdown(),
      a("div.dataTables_filter.ui.input", b.table().container())
        .removeClass("input")
        .addClass("form"),
      a("div.dataTables_filter input", b.table().container()).wrap(
        '<span class="ui input" />'
      ));
  });
  return d;
