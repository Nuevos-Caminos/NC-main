...
<style>
	input[type=checkbox]
{
  /* Caixas de seleção de tamanho duplo */
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> Crear tema</button>
				</span>
					</div>
					...
					<div class="card-body">
						<ul class="w-100 list-group" id="topic-list">
							...
							<li class="list-group-item mb-4">
								...
								<p class="row justify-content-left"><span class="badge badge-success text-white"><i>Publicado por: <?php echo $row['name'] ?></i></span></p>
								<hr>
								
								<span class="float-left badge badge-secondary text-white"><?php echo number_format($view) ?> vista/s</span>
								<span class="float-left badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format($view) ?> comentario/s <?php echo $replies > 0 ? " and ".number_format($replies).' replies':'' ?> </span>
...
<script>
	...
	$('.edit_topic').click(function(){
		uni_modal("Editar tema","manage_topic.php?id="+$(this).attr('data-id'),'mid-large')
